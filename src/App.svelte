<script lang="ts">
  ...
  const FONT_STACKS: Record<string, string> = {
    '系统默认': "'HarmonyOS Sans SC', 'MiSans', 'Microsoft YaHei UI', 'Microsoft YaHei', 'Segoe UI Variable Text', 'Segoe UI', 'Noto Sans SC', 'PingFang SC', ui-sans-serif, system-ui, sans-serif",
