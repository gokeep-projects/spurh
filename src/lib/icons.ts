...
export const UI_ICONS = {
  ...
  alert: S('<path d="M12 3.6 2.9 19.2a1 1 0 0 0 .87 1.5h16.46a1 1 0 0 0 .87-1.5z"/><path d="M12 9.5v4.4"/><path d="M12 17.1h.01"/>'),
  clock: S('<circle cx="12" cy="12" r="8.6"/><path d="M12 7.2V12l3.2 2.1"/>'),
} as const;
