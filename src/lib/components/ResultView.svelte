...
<style>
  ...
  @keyframes aiAnswerIn { from { opacity: 0; transform: translateY(10px) scale(.98); } to { opacity: 1; transform: translateY(0) scale(1); } }
  @keyframes aiGlowBreath { 0%, 100% { opacity: .55; } 50% { opacity: 1; } }
  ...
  .code-lines :global(i) { display: block; font-style: normal; }
