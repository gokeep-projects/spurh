...
<style>
  ...
  .ai-head { display: flex; align-items: center; justify-content: flex-start; gap: 9px; padding: 7px 10px; }
  ...
  .ai-presets { position: relative; z-index: 1; display: flex; align-items: center; gap: 5px; min-width: 0; flex: 1; overflow-x: auto; scrollbar-width: none; }
  ...
  .ai-stream { display: flex; flex-direction: column; gap: 9px; max-height: min(24vh, 260px); overflow: auto; padding-right: 2px; }
