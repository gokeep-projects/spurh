...
<style>
  ...
  .ai-toggle { height: 26px; display: inline-flex; align-items: center; gap: 6px; padding: 0 10px; cursor: pointer; color: var(--accent); font-size: 13px; font-weight: 700; border: 1px solid color-mix(in srgb, var(--accent) 30%, var(--line)); border-radius: 999px; background: var(--accent-soft); transition: all .15s ease; }
  ...
  .ai-preset { height: 22px; flex: 0 0 auto; padding: 0 10.5px; cursor: pointer; color: var(--muted); font-size: 13.5px; border: 1px solid var(--line); border-radius: 999px; background: var(--bg); transition: all .15s ease; }
  ...
  .ai-notice { display: flex; align-items: center; gap: 8px; padding: 10px 12px; color: var(--muted); font-size: 13px; border: 1px dashed var(--line-2); border-radius: 8px; background: var(--bg); }
  ...
  .ai-send { height: 32px; flex: 0 0 auto; padding: 0 14px; cursor: pointer; color: #fff; font-size: 13px; font-weight: 700; border: 0; border-radius: 7px; background: var(--btn-gradient); box-shadow: 0 4px 12px color-mix(in srgb, var(--accent) 22%, transparent); transition: all .15s ease; }
  ...
  .ai-reasoning p { margin: 0; padding: 8px 10px; color: var(--muted); font-size: 13px; line-height: 1.6; border-left: 2px solid var(--line-2); background: var(--bg); }
  ...
  .ai-waiting { display: flex; align-items: center; gap: 8px; padding: 12px; color: var(--muted); font-size: 13px; }
  .ai-result-actions { display: flex; justify-content: flex-end; gap: 6px; }
  .ai-result-actions button { height: 24px; padding: 0 10px; cursor: pointer; color: var(--muted); font-size: 13px; border: 1px solid var(--line); border-radius: 6px; background: var(--bg); transition: all .15s ease; }
  ...
  .ai-error { display: flex; align-items: center; gap: 7px; padding: 8px 10px; color: var(--danger); font-size: 13px; border: 1px solid color-mix(in srgb, var(--danger) 30%, var(--line)); border-radius: 7px; background: color-mix(in srgb, var(--danger) 6%, transparent); }
