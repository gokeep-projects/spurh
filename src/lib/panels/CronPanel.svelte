...
<style>
  ...
  .cron-sec-title b { color: var(--muted); font-size: 12px; letter-spacing: 1.5px; }
  .cron-sec-title small { color: var(--muted-2); font-size: 12.5px; }
  ...
  .cron-type-group > small { flex: 0 0 auto; width: 50px; color: var(--muted-2); font-size: 12.5px; }
  ...
  .cron-controls .custom-expr input { height: 32px; width: 100%; padding: 0 10px; color: var(--text); font: 500 13px 'Cascadia Code', monospace; border: 1px solid var(--line); border-radius: 6px; outline: 0; background: var(--bg); }
  ...
  .preview-head { display: flex; align-items: center; justify-content: space-between; margin-bottom: 8px; color: var(--muted); font-size: 12px; letter-spacing: 1.5px; }
  .preview-head button { height: 24px; padding: 0 10px; cursor: pointer; color: var(--accent); font-size: 12px; border: 1px solid color-mix(in srgb, var(--accent) 35%, var(--line)); border-radius: 6px; background: var(--accent-soft); }
  ...
  .preview-runs span { padding: 4px 8px; color: var(--text); font-size: 12px; border: 1px solid var(--line); border-radius: 6px; background: var(--bg); }
  ...
  .cron-clear { height: 30px; padding: 0 10px; cursor: pointer; color: var(--muted); font-size: 12px; border: 1px solid transparent; border-radius: 6px; background: transparent; }
  ...
  .cron-examples button { height: 24px; padding: 0 10px; cursor: pointer; color: var(--muted); font-size: 12.5px; border: 1px dashed var(--line-2); border-radius: 12px; background: transparent; white-space: nowrap; }
