...
<style>
  ...
  .sql-users-empty { padding: 34px 16px; color: var(--muted); font-size: 12px; text-align: center; border: 1px dashed var(--line-2); border-radius: 10px; }
  ...
  .sql-user-id small { color: var(--muted); font: 500 10.5px 'Cascadia Code', monospace; }
  .sql-user-attrs { display: flex; gap: 5px; flex-wrap: wrap; }
  .sql-user-attrs em { padding: 2px 7px; color: var(--muted); font-size: 10px; font-style: normal; border: 1px solid var(--line); border-radius: 5px; background: var(--panel-2); }
  ...
  .sql-user-panel label span { color: var(--muted); font-size: 10.5px; }
  ...
  .sql-grants-head b { font-size: 12px; }
  .sql-grants-head select { height: 30px; padding: 0 8px; color: var(--text); font-size: 11.5px; border: 1px solid var(--line-2); border-radius: 7px; background: var(--panel); outline: 0; }
  .sql-privs { display: flex; gap: 4px 10px; flex-wrap: wrap; }
  .sql-privs label { display: inline-flex; align-items: center; gap: 4px; color: var(--muted); font-size: 10.5px; flex: 0 0 auto; min-width: 0; }
  .sql-privs input { width: auto; }
  .sql-grants-msg { color: var(--accent); font-size: 11px; }
  .sql-grants-lines { display: flex; flex-direction: column; gap: 3px; max-height: 220px; overflow: auto; }
  .sql-grants-lines code { padding: 4px 8px; color: var(--text); font: 450 10.5px/1.5 'Cascadia Code', monospace; border: 1px solid var(--line); border-radius: 6px; background: var(--panel); white-space: pre-wrap; word-break: break-all; }
  ...
  .sql-user-create > b { width: 100%; font-size: 12px; }
  .sql-user-create label { display: flex; flex-direction: column; gap: 4px; min-width: 160px; flex: 1; }
  .sql-user-create label span { color: var(--muted); font-size: 10.5px; }
  ...
  .sql-user-create input[type='text'], .sql-user-create input[type='password'], .sql-user-panel input[type='text'], .sql-user-panel input[type='password'] { height: 32px; padding: 0 10px; color: var(--text); font-size: 12.5px; border: 1px solid var(--line-2); border-radius: 8px; background: var(--panel); outline: 0; }
